	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				('role', models.CharField(
					choices=[('AD', 'Administrator'), ('STU', 'Sinh viên'), ('ASST', 'Trợ lý sinh viên'), ('SPC', 'Chuyên viên cộng tác sinh viên')],
					default='STU', max_length=4, null=True)),
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('academic_year',
				 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='schools.academicyear')),
				('account', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s',
				                                 to=settings.AUTH_USER_MODEL)),
				('educational_system',
				 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='schools.educationalsystem')),
